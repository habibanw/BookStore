...
import type {BookItem, Customer, OrderDetails, ServerErrorResponse} from '@/types'
...
export const useCartStore = defineStore('CartStore', {
    ...
    actions: {
        ...
        async placeOrder(customerForm: Customer): Promise<OrderDetails | ServerErrorResponse> {
            ...
            if (response.ok) {
                if ('order' in placeOrderResponse) {
